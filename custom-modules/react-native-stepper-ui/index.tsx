        ...
        <View
          ...
          {active !== 0 && (
            <TouchableOpacity
              ...
              <Text style={[{color: 'white'}, buttonTextStyle]}>{backText}</Text>
            </TouchableOpacity>
          )}
          {content.length - 1 !== active && (
            <TouchableOpacity
              ...
              <Text style={[{color: 'white'}, buttonTextStyle]}>{nextText}</Text>
            </TouchableOpacity>
          )}
          {content.length - 1 === active && (
            <TouchableOpacity
              ...
              onPress={() => onFinish()}>
              <Text style={[{color: 'white'}, buttonTextStyle]}>{finishText}</Text>
            </TouchableOpacity>
          )}
        </View>
      )}
